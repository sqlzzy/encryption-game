...
io.on("connection", (socket) => {
  ...
  socket.on("initTask", (data) => initTask(rooms, io, data));

  socket.on("checkAnswer", (data) => checkAnswer(socket, rooms, data));

  socket.on("initWinnerOfRound", (data) =>
    initWinnerOfRound(socket, rooms, io, data)
  );
